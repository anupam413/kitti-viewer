...
class Viewer:
    ...
    def show_2D(self,box_color = (255,0,0),show_box_info=True,show_ids=True,points_colors=(0,0,255), show_box_heading=True, ini_labels=None):
        """
        ...
        for info in self.boxes_info:
            ...
            if boxes is None:
                ...
                for box_id in range(len(boxes)):
                    ...
                    # depth = math.sqrt((box[5]**2) + (box[4]**2) + (box[3]**2))
                    ...
                    depth_f = abs(ini_labels[box_id][5] * math.sin(ini_labels[box_id][6])) - (ini_labels[box_id][2] / 2) 
                    # depth_r = ini_labels[box_id][3] - (ini_labels[box_id][1] /2)
                    # depth_l = ini_labels[box_id][3] + (ini_labels[box_id][1] /2)
                    depth = ini_labels[box_id][5]
                    print("INFO", info, depth)
                    print("front:", depth_f)
                    # print("right:", depth_r)
                    # print("left:", depth_l)
